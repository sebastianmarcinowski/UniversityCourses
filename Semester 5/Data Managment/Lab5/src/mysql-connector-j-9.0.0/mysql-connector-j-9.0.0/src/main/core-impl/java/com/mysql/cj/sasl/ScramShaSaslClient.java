        ...
        try {
            switch (this.scramStage) {
                ...
                case SERVER_FIRST_CLIENT_FINAL: // Process server-first-message & client-final-message.
                    ...
                    if (!serverFirstAttributes.containsKey("r") || !serverFirstAttributes.containsKey("META-INF") || !serverFirstAttributes.containsKey("i")) {
                    ...
                    byte[] salt = Base64.getDecoder().decode(serverFirstAttributes.get("META-INF"));
